...
def draw(canvas):
    ...
    if int(ball_pos[0]) <= BALL_RADIUS + PAD_WIDTH and ball_pos[1] >= paddle1_pos[1] - HALF_PAD_HEIGHT - (BALL_RADIUS / 2) and ball_pos[1] <= paddle1_pos[1] + HALF_PAD_HEIGHT + (BALL_RADIUS / 2):
    ...
    if int(ball_pos[0]) >= WIDTH + 1 - BALL_RADIUS - PAD_WIDTH and ball_pos[1] >= paddle2_pos[1] - HALF_PAD_HEIGHT - (BALL_RADIUS / 2) and ball_pos[1] <= paddle2_pos[1] + HALF_PAD_HEIGHT + (BALL_RADIUS / 2):
        ball_vel[0] = -ball_vel[0]
        ball_vel[0] *= 1.1
        ball_vel[1] *= 1.1
